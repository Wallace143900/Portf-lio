            ...
            <div className={styles.divSection}> 
                <div className={styles.DivMe}>
                    ...
                    <div className={styles.divButtons}>
                        <a href="https://drive.google.com/file/d/1Dj8Gc_1CCEwDNTEIrDwlPFHpcZw4Abks/view?usp=sharing" className="buttonCV" id={styles.buttonCV} target="_blank">Download CV</a>
